...
export default {
  ...
  theme: {
    extend: {
      ...
      screens: {
        'xs': '475px',    // Extra small devices (phones in landscape)
      ...
      keyframes: {
        ...
        // New animations for better mobile UX
        "fade-in": {
          from: { opacity: "0" },
          to: { opacity: "1" },
        },
      ...
      boxShadow: {
        ...
        'mobile-top': '0 -4px 6px -1px rgba(0, 0, 0, 0.1), 0 -2px 4px -1px rgba(0, 0, 0, 0.06)',
      },
  ...
  plugins: [
    ...
    // Custom plugin for better mobile utilities
